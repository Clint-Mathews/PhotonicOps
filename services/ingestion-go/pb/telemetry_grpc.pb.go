...
type TelemetryServiceClient interface {
	...
	StreamTelemetry(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[OpticalFrame, StreamResponse], error)
}
...
func (c *telemetryServiceClient) StreamTelemetry(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[OpticalFrame, StreamResponse], error) {
	...
	x := &grpc.GenericClientStream[OpticalFrame, StreamResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TelemetryService_StreamTelemetryClient = grpc.ClientStreamingClient[OpticalFrame, StreamResponse]
...
type TelemetryServiceServer interface {
	// StreamTelemetry pushes optical sensor data to the server in real-time.
	StreamTelemetry(grpc.ClientStreamingServer[OpticalFrame, StreamResponse]) error
...
func (UnimplementedTelemetryServiceServer) StreamTelemetry(grpc.ClientStreamingServer[OpticalFrame, StreamResponse]) error {
...
func _TelemetryService_StreamTelemetry_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TelemetryServiceServer).StreamTelemetry(&grpc.GenericServerStream[OpticalFrame, StreamResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TelemetryService_StreamTelemetryServer = grpc.ClientStreamingServer[OpticalFrame, StreamResponse]
