...
# 1. Check Ollama API
echo -n "[1/3] Checking Ollama API (localhost:11434)... "
...
# 2. Check Langfuse UI
echo -n "[2/3] Checking Langfuse API/UI (localhost:3000)... "
...
# 3. Check for Native Apple Silicon Execution (arm64)
echo "[3/3] Checking Container Architectures (Zero Rosetta Emulation)..."
